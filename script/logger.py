...
class Logger:
    ...
    def print_logger(self):
        ...
        if self.data.feature == 0:
            self.print_window.print_text_green("adaptive air conditionor \n")
            ...
            self.print_window.print_text_red("quiet vehicle \n")
            ...
            self.print_window.print_text_red("Fatigue Relief \n")
            self.print_window.print_text_red("adjust FCW sensitivity suggestion \n")
        elif self.data.feature == 1:
            self.print_window.print_text_red("adaptive air conditionor \n")
            self.print_window.print_text_red("adaptive seat & mirror\n")
            self.print_window.print_text_red("wedge suggestion \n")
            self.print_window.print_text_green("features inquire \n")
            self.print_window.print_text_red("sentry mode suggestion \n")
            self.print_window.print_text_red("vehicle height adjust \n")
            self.print_window.print_text_red("quiet vehicle \n")
            self.print_window.print_text_red("traffic light Red-to-green reminder \n")
            ...
            self.print_window.print_text_red("traffic light Red-to-green reminder \n")
            self.print_window.print_text_green("local life suggestion \n")
            self.print_window.print_text_red("Fatigue Relief \n")
            self.print_window.print_text_red("adjust FCW sensitivity suggestion \n")
        elif self.data.feature == 4:
            self.print_window.print_text_red("adaptive air conditionor \n")
            self.print_window.print_text_red("adaptive seat & mirror\n")
            self.print_window.print_text_red("wedge suggestion \n")
            self.print_window.print_text_red("features inquire \n")
            ...
            self.print_window.print_text_red("vehicle height adjust \n")
            self.print_window.print_text_red("quiet vehicle \n")
            self.print_window.print_text_green("traffic light Red-to-green reminder \n")
            self.print_window.print_text_green("local life suggestion \n")
            self.print_window.print_text_red("Fatigue Relief \n")
            self.print_window.print_text_red("adjust FCW sensitivity suggestion \n")
        elif self.data.feature == 5:
            self.print_window.print_text_red("adaptive air conditionor \n")
            self.print_window.print_text_red("adaptive seat & mirror\n")
            self.print_window.print_text_red("wedge suggestion \n")
            self.print_window.print_text_red("features inquire \n")
